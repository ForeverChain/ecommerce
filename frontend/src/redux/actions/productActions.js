...
export const getProducts =
  (pageNum, productsPerPage, sortBy, searchText, price, sellerId) =>
  async (dispatch) => {
    try {
      const response = await axios.get(
        `products?page=${pageNum}&limit=${productsPerPage}&sortBy=${sortBy}&searchText=${searchText}&price=${price}${
...
export const getProductsByShopId =
  (pageNum, productsPerPage, sortBy, searchText, price, shopId) =>
  async (dispatch) => {
    try {
      const response = await axios.get(
        `products?page=${pageNum}&limit=${productsPerPage}&sortBy=${sortBy}&searchText=${searchText}&price=${price}${

...
const RegisterPage = ({ history }) => {
    ...
    return (
        <>
            <NavBar />
            <PageHeading title="Нүүр хуудас / Бүртгүүлэх" />
            <section className="section section-center">
                <div className="container h-100">
                    <div className="d-flex justify-content-center h-100">
                        <div className="user_card content-card">
                            <h4 className="content-heading">Бүртгүүлэх</h4>
                            <div className="d-flex justify-content-center form_container auth-page-container">
                                <form onSubmit={handleSubmit} autoComplete="off">
                                    ...
                                    <div className="d-flex justify-content-center mt-3 login_container">
                                        <button className="btn login_btn">Бүртгүүлэх</button>
                                    </div>
                                </form>
                            </div>
                            <div className="mt-4">
                                <div className="d-flex justify-content-center links">
                                    Алв хэдийн аккоунт байгаа юу?{" "}
                                    <Link to="/login" className="ml-2">
                                        Нэвтрэх
                                    </Link>
                                </div>
                                <div className="d-flex justify-content-center links">
                                    <Link to="/forgot-password">Нууц үгээ мартсан уу?</Link>
                                </div>
                            </div>
                        </div>
                    </div>

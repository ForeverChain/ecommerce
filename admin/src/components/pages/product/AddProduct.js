                                ...
                                <div className="col-12 grid-margin">
                                    <div className="card">
                                        <div className="card-body">
                                            <h4 className="card-title">Бараа нэмэх</h4>
                                            <form className="form-sample" onSubmit={handleSubmit}>
                                                <p className="card-description"></p>
                                                <div className="row">
                                                    <div className="col-md-6">
                                                        <div className="form-group row">
                                                            <label className="col-sm-3 col-form-label">Гарчиг</label>
                                                            <div className="col-sm-9">
                                                                <input type="text" className={"form-control form-control-lg" + (submitted && !formState.values.title ? " is-invalid" : "")} name="title" onChange={handleChange} value={formState.values.title || ""} />
                                                ...
                                                <div className="row">
                                                    <div className="col-md-6">
                                                        <div className="form-group row">
                                                            <label className="col-sm-3 col-form-label">Тайлбар</label>
                                                            <div className="col-sm-9">
                                                                <textarea rows={5} cols={5} className={"form-control form-control-lg" + (submitted && !formState.values.title ? " is-invalid" : "")} name="description" onChange={handleChange} value={formState.values.description || ""} />
                                                ...
                                                <div className="row">
                                                    <div className="col-md-6">
                                                        <div className="form-group row">
                                                            <label className="col-sm-3 col-form-label">Зургын URL</label>
                                                            <div className="col-sm-9">
                                                        ...
                                                        <div className="form-group row">
                                                            ...
                                                            <div className="col-sm-9">
                                                                <select className="form-control" name="category" multiple>
                                                                    <option value="man">Эрчүүдэд</option>
                                                                    <option value="woman">Эмэгтэйчүүдэд</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>

                                ...
                                <div className="col-lg-12 grid-margin stretch-card">
                                    <div className="card">
                                        <div className="card-body">
                                            <h4 className="card-title">Бараа</h4>
                                            <div className="row">
                                                <div className="col-md-12">
                                                    <div className="form-group row">
                                                        ...
                                                        <div className="col-sm-1">
                                                            ...
                                                            <CSVLink data={csvData} headers={headers} className="d-none" ref={myRefBtn} filename={"Product-Data.csv"}></CSVLink>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="table-responsive">
                                                <table className="table table-hover products-table">
                                                    <thead>
                                                        <tr>
                                                            <th className="product-title">Гарчиг</th>
                                                            <th className="product-image">Зураг</th>
                                                            <th className="product-price">Үнэ</th>
                                                            <th className="product-stock">Тоо хэмжээ</th>
                                                            <th className="product-action">Үйлдэл</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
